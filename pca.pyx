...
def pca(np.ndarray[DTYPE_t,ndim=2] vectors,int dim,str rowColumn):
...
def reconst(np.ndarray[DTYPE_t,ndim=2] reducedDim,np.ndarray[DTYPE_t,ndim=2] eVectors,np.ndarray[DTYPE_t,ndim=1] meanVec,str rowColumn):
